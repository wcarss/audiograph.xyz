...
module.exports = function () {
  ...
  player.pauseToggle = pauseToggle;
  ...
  function mute () {
    playingAudio.oldVolume = playingAudio.volume;
    playingAudio.volume = 0;
  }

  function unmute () {
    playingAudio.volume = playingAudio.oldVolume;
  }

  function volumeDown () {
    if (playingAudio.volume > 0.04) {
      playingAudio.volume -= 0.04;
    } else {
      playingAudio.volume = 0;
    }
  }
