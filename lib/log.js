...
module.exports.intro = function (msg) {
  console.log([
    '%c🎹 Audiocraft, for exploring music visually',
    '%c\t\tCreated by Matt DesLauriers (%chttp://twitter.com/mattdesl/%c)',
    '%c\t\tRemixed by Wyatt Carss (%chttp://twitter.com/wcarss/%c)',
    `%c\t\tAudio by ${artist}`,
    '%c\t\tColor palettes sourced from ColourLovers.com',
    '%c\t\tWith UX help from Melissa Hernandez (Wyatt has ruined her good work with hacks)'
  ].join('\n'), `${font} background: #efefef; padding: 1px 5px;`, font, `${font} color: #3aa3e0;`, font, font, `${font} color: #3aa3e0;`, font, font, font, font);
};
